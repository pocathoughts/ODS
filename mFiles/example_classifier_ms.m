...
I_FLAIR=im2double(imread('patient1_FLAIR.png'));
I_T1=im2double(imread('patient1_T1.png'));
I_T2=im2double(imread('patient1_T2.png'));
...
I_lesions_patient1=im2double(imread('patient1_lesion.png'));
...
I_FLAIR=im2double(imread('patient2_FLAIR.png'));
I_T1=im2double(imread('patient2_T1.png'));
I_T2=im2double(imread('patient2_T2.png'));
...
% The Multiple Sclerosis Lesions marked by an expert
I_lesions_patient2=im2double(imread('patient2_lesion.png'));
...
I_FLAIR=im2double(imread('patient3_FLAIR.png'));
I_T1=im2double(imread('patient3_T1.png'));
I_T2=im2double(imread('patient3_T2.png'));
% Combine the data to one image
